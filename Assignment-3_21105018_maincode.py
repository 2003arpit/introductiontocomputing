...
#Programme for next date
if input_date<month_days:
    input_date+=1
else:
    input_date=1
    if input_month==12:
...
#Printing next date
print("Next Date is:",input_date,"/",input_month,"/",input_year)
